namespace Trabalho
{
    partial class frmModificaMapa
    {
        ...
        private void InitializeComponent()
        {
            ...
            LBLinspecao.Location = new Point(268, 362);
            ...
            LBLdatadeatracacao.Location = new Point(68, 362);
            ...
            LBLprevisao.Location = new Point(794, 362);
            LBLprevisao.Name = "LBLprevisao";
            LBLprevisao.Size = new Size(64, 20);
            LBLprevisao.TabIndex = 269;
            ...
            LBLdatadeembarque.Location = new Point(592, 362);
            ...
            label22.Location = new Point(595, 21);
            ...
            label20.Location = new Point(415, 21);
            ...
            label18.Location = new Point(248, 21);
            ...
            // 
            CBparametrizacaolilpco.DataBindings.Add(new Binding("Text", bsModificaMAPA, "ParametrizacaoLILPCO", true));
            CBparametrizacaolilpco.DataBindings.Add(new Binding("SelectedItem", bsModificaMAPA, "ParametrizacaoLILPCO", true));
            CBparametrizacaolilpco.FormattingEnabled = true;
            CBparametrizacaolilpco.Items.AddRange(new object[] { "Verde", "Amarelo", "Vermelho" });
            CBparametrizacaolilpco.Location = new Point(586, 45);
            ...
            DTPdatadedeferimentolilpco.DataBindings.Add(new Binding("Value", bsModificaMAPA, "DataDeferimentoLILPCO", true));
            DTPdatadedeferimentolilpco.Format = DateTimePickerFormat.Short;
            DTPdatadedeferimentolilpco.Location = new Point(409, 44);
            ...
            DTPdataderegistrolilpco.DataBindings.Add(new Binding("Value", bsModificaMAPA, "DataRegistroLILPCO", true));
            DTPdataderegistrolilpco.Format = DateTimePickerFormat.Short;
            DTPdataderegistrolilpco.Location = new Point(227, 44);
            ...
            TXTlilpco.DataBindings.Add(new Binding("Text", bsModificaMAPA, "LI_LPCO", true));
            TXTlilpco.Location = new Point(68, 33);
            ...
            label26.Location = new Point(34, 35);
            ...
            groupBox2.Location = new Point(25, 277);
            ...
            label23.Location = new Point(753, 22);
            ...
            label6.Location = new Point(563, 22);
            label6.Name = "label6";
            ...
            // CBparametrizacaodi
            // 
            CBparametrizacaodi.DataBindings.Add(new Binding("Text", bsModificaMAPA, "ParametrizacaoDI", true));
            CBparametrizacaodi.DataBindings.Add(new Binding("SelectedItem", bsModificaMAPA, "ParametrizacaoDI", true));
            CBparametrizacaodi.FormattingEnabled = true;
            CBparametrizacaodi.Items.AddRange(new object[] { "Verde", "Amarelo", "Vermelho" });
            CBparametrizacaodi.Location = new Point(741, 45);
            ...
            DTPdatadecarregamentodi.DataBindings.Add(new Binding("Value", bsModificaMAPA, "DataCarregamentoDI", true));
            DTPdatadecarregamentodi.Format = DateTimePickerFormat.Short;
            DTPdatadecarregamentodi.Location = new Point(558, 45);
            ...
            DTPdatadedesembaracodi.DataBindings.Add(new Binding("Value", bsModificaMAPA, "DataDesembaracoDI", true));
            DTPdatadedesembaracodi.Format = DateTimePickerFormat.Short;
            DTPdatadedesembaracodi.Location = new Point(377, 45);
            ...
            DTPdataderegistrodi.DataBindings.Add(new Binding("Value", bsModificaMAPA, "DataRegistroDI", true));
            DTPdataderegistrodi.Format = DateTimePickerFormat.Short;
            DTPdataderegistrodi.Location = new Point(197, 45);
            ...
            TXTdi.DataBindings.Add(new Binding("Text", bsModificaMAPA, "DI", true));
            TXTdi.Location = new Point(59, 31);
            TXTdi.Name = "TXTdi";
            ...
            label21.Location = new Point(25, 33);
            ...
            // NUMfreetime
            // 
            NUMfreetime.DataBindings.Add(new Binding("Value", bsModificaMAPA, "FreeTime", true));
            NUMfreetime.Location = new Point(750, 109);
            NUMfreetime.Name = "NUMfreetime";
            NUMfreetime.Size = new Size(166, 23);
            NUMfreetime.TabIndex = 266;
            // 
            // cbEmbarque
            // 
            cbEmbarque.AutoSize = true;
            cbEmbarque.DataBindings.Add(new Binding("Checked", bsModificaMAPA, "PossuiEmbarque", true));
            cbEmbarque.Location = new Point(469, 396);
            ...
            label17.Location = new Point(138, 24);
            ...
            TXTimportador.Location = new Point(233, 22);
            ...
            DTPdatadeinspecao.DataBindings.Add(new Binding("Value", bsModificaMAPA, "Inspecao", true));
            DTPdatadeinspecao.Format = DateTimePickerFormat.Short;
            DTPdatadeinspecao.Location = new Point(235, 386);
            ...
            CBamostra.Location = new Point(68, 521);
            ...
            CBdesovado.DataBindings.Add(new Binding("Checked", bsModificaMAPA, "Desovado", true));
            CBdesovado.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
            CBdesovado.Location = new Point(162, 521);
            CBdesovado.Name = "CBdesovado";
            CBdesovado.Size = new Size(98, 25);
            CBdesovado.TabIndex = 230;
            ...
            checkBox2.Location = new Point(162, 528);
            checkBox2.Name = "checkBox2";
            checkBox2.Size = new Size(88, 25);
            checkBox2.TabIndex = 260;
            ...
            checkBox1.Location = new Point(162, 528);
            checkBox1.Name = "checkBox1";
            checkBox1.Size = new Size(98, 25);
            checkBox1.TabIndex = 229;
            ...
            TXTportodedestino.DataBindings.Add(new Binding("Text", bsModificaMAPA, "PortoDestino", true));
            TXTportodedestino.Location = new Point(797, 71);
            TXTportodedestino.Name = "TXTportodedestino";
            TXTportodedestino.Size = new Size(119, 23);
            TXTportodedestino.TabIndex = 256;
            // 
            // label15
            // 
            ...
            label15.Location = new Point(666, 111);
            ...
            btnAdiciona.Location = new Point(788, 514);
            ...
            DTPdatadeatracacao.DataBindings.Add(new Binding("Value", bsModificaMAPA, "DataDeAtracacao", true));
            DTPdatadeatracacao.Format = DateTimePickerFormat.Short;
            DTPdatadeatracacao.Location = new Point(67, 386);
            ...
            label12.Location = new Point(494, 149);
            ...
            DTPdatadeembarque.DataBindings.Add(new Binding("Value", bsModificaMAPA, "DataEmbarque", true));
            DTPdatadeembarque.Format = DateTimePickerFormat.Short;
            DTPdatadeembarque.Location = new Point(592, 385);
            ...
            DTPdatadeprevisao.DataBindings.Add(new Binding("Value", bsModificaMAPA, "Previsao", true));
            DTPdatadeprevisao.Format = DateTimePickerFormat.Short;
            DTPdatadeprevisao.Location = new Point(759, 385);
            ...
            DTPdatadeprevisao.TabIndex = 250;
            ...
            label11.Location = new Point(638, 24);
            ...
            label9.Location = new Point(413, 24);
            label9.Name = "label9";
            ...
            TXTsr.Location = new Point(679, 22);
            TXTsr.Name = "TXTsr";
            ...
            TXTnr.Location = new Point(455, 22);
            TXTnr.Name = "TXTnr";
            ...
            label10.Location = new Point(56, 425);
            ...
            TXTstatusdoprocesso.Location = new Point(202, 424);
            ...
            label5.Location = new Point(189, 153);
            label5.Name = "label5";
            ...
            TXTbl.DataBindings.Add(new Binding("Text", bsModificaMAPA, "BL", true));
            TXTbl.Location = new Point(222, 151);
            TXTbl.Name = "TXTbl";
            ...
            TXTagentedecarga.DataBindings.Add(new Binding("Text", bsModificaMAPA, "AgenteDeCarga", true));
            TXTagentedecarga.Location = new Point(625, 147);
            TXTagentedecarga.Name = "TXTagentedecarga";
            TXTagentedecarga.Size = new Size(119, 23);
            TXTagentedecarga.TabIndex = 241;
            // 
            // label7
            // 
            ...
            label8.Location = new Point(102, 465);
            label8.Name = "label8";
            ...
            TXTpendencia.Location = new Point(185, 463);
            ...
            label3.Location = new Point(50, 111);
            label3.Name = "label3";
            ...
            TXTordem.DataBindings.Add(new Binding("Text", bsModificaMAPA, "Ordem", true));
            TXTordem.Location = new Point(125, 109);
            TXTordem.Name = "TXTordem";
            TXTordem.Size = new Size(157, 23);
            TXTordem.TabIndex = 235;
            // 
            // label2
            // 
            ...
            label2.Location = new Point(355, 111);
            label2.Name = "label2";
            ...
            TXTflo.DataBindings.Add(new Binding("Text", bsModificaMAPA, "FLO", true));
            TXTflo.Location = new Point(398, 109);
            TXTflo.Name = "TXTflo";
            ...
            lblPEmbarque.Location = new Point(438, 373);
