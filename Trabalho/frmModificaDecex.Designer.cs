namespace Trabalho
{
    partial class frmModificaDecex
    {
        ...
        private void InitializeComponent()
        {
            ...
            DTPdatadedeferimentolilpco.DataBindings.Add(new Binding("Value", bsModificaDecex, "DataDeferimentoLPCO", true));
            DTPdatadedeferimentolilpco.DataBindings.Add(new Binding("Text", bsModificaDecex, "DataDeferimentoLPCO", true));
            ...
            DTPdataderegistrolilpco.DataBindings.Add(new Binding("Text", bsModificaDecex, "DataRegistroLPCO", true));
            DTPdataderegistrolilpco.DataBindings.Add(new Binding("Value", bsModificaDecex, "DataRegistroLPCO", true));
            ...
            cbEmbarque.DataBindings.Add(new Binding("Checked", bsModificaDecex, "TEmbarque", true));
            ...
            label11.Location = new Point(372, 31);
            ...
            label9.Location = new Point(147, 31);
            label9.Name = "label9";
