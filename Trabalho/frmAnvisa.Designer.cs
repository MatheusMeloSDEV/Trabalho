namespace Trabalho
{
    partial class FrmAnvisa
    {
        ...
        private void InitializeComponent()
        {
            ...
            ((System.ComponentModel.ISupportInitialize)DgvAnvisa).BeginInit();
            SuspendLayout();
            // 
            // BsAnvisa
            // 
            ...
            // DgvAnvisa
            // 
            DgvAnvisa.AllowUserToAddRows = false;
            DgvAnvisa.AllowUserToDeleteRows = false;
            DgvAnvisa.AutoGenerateColumns = false;
            DgvAnvisa.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            DgvAnvisa.Columns.AddRange(new DataGridViewColumn[]
            {
            ...
            DgvAnvisa.DataSource = BsAnvisa;
            DgvAnvisa.Location = new Point(12, 41);
            DgvAnvisa.Name = "DgvAnvisa";
            DgvAnvisa.RowHeadersVisible = false;
            DgvAnvisa.Size = new Size(776, 397);
            DgvAnvisa.TabIndex = 11;
            // 
            // ColId
            // 
            ColId.HeaderText = "Id";
            ...
            Controls.Add(DgvAnvisa);
            Controls.Add(ToolStripMain);
            Name = "FrmAnvisa";
            Text = "Gestão de Processos Anvisa";
            Load += FrmAnvisa_Load;
            ToolStripMain.ResumeLayout(false);
            ToolStripMain.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)BsAnvisa).EndInit();
            ((System.ComponentModel.ISupportInitialize)DgvAnvisa).EndInit();
            ResumeLayout(false);
        }
        ...
        private DataGridView DgvAnvisa;
