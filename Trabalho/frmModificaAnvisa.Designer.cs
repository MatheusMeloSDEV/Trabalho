namespace Trabalho
{
    partial class frmModificaAnvisa
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            CBparametrizacaolilpco.DataBindings.Add(new Binding("Text", bsModificaAnvisa, "ParametrizacaoLILPCO", true));
            ...
            DTPdatadedeferimentolilpco.DataBindings.Add(new Binding("Value", bsModificaAnvisa, "DataDeferimentoLILPCO", true));
            ...
            DTPdataderegistrolilpco.DataBindings.Add(new Binding("Value", bsModificaAnvisa, "DataRegistroLILPCO", true));
            ...
            TXTlilpco.DataBindings.Add(new Binding("Text", bsModificaAnvisa, "LI_LPCO", true));
            ...
            // CBparametrizacaodi
            // 
            CBparametrizacaodi.DataBindings.Add(new Binding("Text", bsModificaAnvisa, "ParametrizacaoDI", true));
            ...
            DTPdatadecarregamentodi.DataBindings.Add(new Binding("Value", bsModificaAnvisa, "DataCarregamentoDI", true));
            ...
            DTPdatadedesembaracodi.DataBindings.Add(new Binding("Value", bsModificaAnvisa, "DataDesembaracoDI", true));
            ...
            DTPdataderegistrodi.DataBindings.Add(new Binding("Value", bsModificaAnvisa, "DataRegistroDI", true));
            ...
            TXTdi.DataBindings.Add(new Binding("Text", bsModificaAnvisa, "DI", true));
            ...
            // NUMfreetime
            // 
            NUMfreetime.DataBindings.Add(new Binding("Value", bsModificaAnvisa, "FreeTime", true));
            ...
            cbEmbarque.DataBindings.Add(new Binding("Checked", bsModificaAnvisa, "PossuiEmbarque", true));
            ...
            DTPdatadeinspecao.DataBindings.Add(new Binding("Value", bsModificaAnvisa, "Inspecao", true));
            ...
            CBdesovado.DataBindings.Add(new Binding("Checked", bsModificaAnvisa, "Desovado", true));
            ...
            TXTportodedestino.DataBindings.Add(new Binding("Text", bsModificaAnvisa, "PortoDestino", true));
            ...
            DTPdatadeatracacao.DataBindings.Add(new Binding("Value", bsModificaAnvisa, "DataDeAtracacao", true));
            ...
            DTPdatadeembarque.DataBindings.Add(new Binding("Value", bsModificaAnvisa, "DataEmbarque", true));
            ...
            DTPdatadeprevisao.DataBindings.Add(new Binding("Value", bsModificaAnvisa, "Previsao", true));
            ...
            TXTbl.DataBindings.Add(new Binding("Text", bsModificaAnvisa, "BL", true));
            ...
            TXTagentedecarga.DataBindings.Add(new Binding("Text", bsModificaAnvisa, "AgenteDeCarga", true));
            ...
            TXTordem.DataBindings.Add(new Binding("Text", bsModificaAnvisa, "Ordem", true));
            ...
            TXTflo.DataBindings.Add(new Binding("Text", bsModificaAnvisa, "FLO", true));
