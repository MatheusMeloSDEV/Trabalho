    ...
    public class RepositorioFatura
    {
        ...
        public async Task UpdateAsync(Fatura fatura)
        {
            ...
            var update = Builders<Fatura>.Update
                ...
                .Set(f => f.Valorcif, fatura.Valorcif)
                .Set(f => f.DataAtracacao, fatura.DataAtracacao)
                .Set(f => f.Navio, fatura.Navio)
                ...
                .Set(f => f.AgenciaN, fatura.AgenciaN)
                .Set(f => f.AgenciaP, fatura.AgenciaP)
                .Set(f => f.AgenciaN1, fatura.AgenciaN1)
                .Set(f => f.AgenciaP1, fatura.AgenciaP1)
